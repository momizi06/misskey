...
export * as 'i/purge-timeline-cache' from './endpoints/i/purge-timeline-cache.js';
...
export * as 'admin/drive/delete-all-files-of-a-user' from './endpoints/admin/drive/delete-all-files-of-a-user.js';
